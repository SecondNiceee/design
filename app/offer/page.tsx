      ...
      <main className="relative z-10 px-4 sm:px-6 lg:px-16 py-8 lg:py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 lg:mt-16 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-gradient-to-r from-[#6B21A8] via-[#7C3AED] to-[#8B5CF6] text-white hover:from-[#581C87] hover:via-[#6D28D9] hover:to-[#7C3AED] px-8 py-6 text-lg rounded-full shadow-[0_0_30px_rgba(139,92,246,0.5)] min-w-[250px]"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto bg-gradient-to-r from-[#6B21A8] via-[#7C3AED] to-[#8B5CF6] text-white hover:from-[#581C87] hover:via-[#6D28D9] hover:to-[#7C3AED] border-0 px-8 py-6 text-lg rounded-full shadow-[0_0_30px_rgba(139,92,246,0.5)] min-w-[250px]"
            >
